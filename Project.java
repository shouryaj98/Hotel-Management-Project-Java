...
class Hotel
{
    ...
    static void bookRoom(int i) {
        ...
        switch (i) {
            case 1:
                for(j=0;j<hotel_obj.luxury_doubleroom.length;j++)
                {
    ...
    static void bill(int rn,int rtype)
    {
        ...
        switch(rtype)
        {
            case 1:
                ...
                System.out.println("-------------------------");
                for(Food obb:hotel_obj.luxury_doubleroom[rn].food)
                {
                    amount+=obb.price;
            ...
            case 2:amount+=3000;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb:hotel_obj.deluxe_doubleroom[rn].food)
                {
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 3:amount+=2200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb:hotel_obj.luxury_singleroom[rn].food)
                {
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 4:amount+=1200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb:hotel_obj.deluxe_singleroom[rn].food)
                {
                    amount += obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
    ...
    static void order(int rn,int rtype)
    {
        ...
        try{
            ...
            do
            {
                ...
                switch(rtype){
                    case 1: hotel_obj.luxury_doubleroom[rn].food.add(new Food(i,q));
                        break;
                    case 2: hotel_obj.deluxe_doubleroom[rn].food.add(new Food(i,q));
                        break;
                    case 3: hotel_obj.luxury_singleroom[rn].food.add(new Food(i,q));
                        break;
                    case 4: hotel_obj.deluxe_singleroom[rn].food.add(new Food(i,q));
                        break;
                }
...
{
    Holder hotel_obj;
    write(Holder hotel_obj)
    {
        this.hotel_obj = hotel_obj;
    }
    @Override
    public void run() {
        try{
